      ...
      <section className="py-12 md:py-20 px-6 bg-warm-white">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="space-y-5 text-[#555] body-text leading-relaxed max-w-3xl">
            <p>
              רוב החברות מקדמות את העובדים המקצועיים החזקים ביותר שלהן לתפקידי ניהול. זה הגיוני. אבל ניהול הוא סט כישורים שונה לחלוטין: הובלת אנשים, ניווט קונפליקטים, קבלת החלטות עם מידע חלקי, בניית תרבות צוותית.
            </p>
            <p>
